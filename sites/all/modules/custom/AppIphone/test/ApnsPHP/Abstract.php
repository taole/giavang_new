...
{
	const ENVIRONMENT_PRODUCTION = 1; /**< @type integer Production environment. */
	const ENVIRONMENT_SANDBOX = 0; /**< @type integer Sandbox environment. */
	...
	/**
	 * Logs a message through the Logger.$telnet gateway.sandbox.push.apple.com 2195
	 *
